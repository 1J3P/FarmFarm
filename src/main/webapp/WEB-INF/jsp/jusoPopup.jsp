...
<script language="javascript">
  ...
  //document.domain = "localhost:9000/popup";
  ...
  */
  ...
  function init(){
    ...
    //var url = "localhost:9000/popup"
    var confmKey = "devU01TX0FVVEgyMDIzMTAxMzE3Mjc0NDExNDE2Nzk=";
    ...
    if(inputYn != "Y"){
      ...
      console.log("@#@#@#" + "${roadAddrPart1}");
      var first = "${roadAddrPart1}";
      var second = "${addrDetail}";
      var third = "${siNm}";
      var fourth = "${sggNm}";
      opener.jusoCallBack(first, second, third, fourth);
      window.close();
    }
  }
</script>
