        ...
        <div class="container allProduct product" style="padding-top:10px">
            <form id="form">
                ...
                <div class="farm_location">
                    ...
                    <div>
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="locationCity" id="location_city" placeholder="OO시/도"
                                   value="${siNm}" readonly>
                        </div>
                        <div class="input-wrapper">
                            <input type="text" name="locationGu" id="location_gu" placeholder="OO시/군/구" value="${sggNm}"
                                   readonly>
                        </div>
                        <p></p>
                        <div class="input-wrapper" style="width: 80%;">
                            <input type="text" name="locationFull" id="location_full" placeholder="전체 주소"
                                   value="${roadAddrPart1}" readonly>
                        </div>
                        <div class="input-wrapper">
                            <input type="text" name="locationDetail" id="location_detail" placeholder="상세 주소"
                                   value="${addrDetail}" readonly>
                        </div>
                ...
                <div class="list">
                    <ul>
                        <li class="mb-15">
                            <button type="button" class="button-large button button-fill" id="openBtn" onclick="sendAjaxRequest()">농장 개설</button>
                        </li>
                    </ul>
                </div>
            </form>
