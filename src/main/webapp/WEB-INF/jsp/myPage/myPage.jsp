                        ...
                        <td class="myProfile" style="vertical-align: middle;">
                            <div class="myPage_container">
                                <div class="item-media">
                                    <img src="${user.image}" class="user-media" alt=""
                    ...
                    <tr>
                        <td class="myFarm" style="vertical-align: middle;">
                            ...
                            <c:if test="${myFarm eq null}">
                                ...
                                <div>
                                    <a href="/farm"
                                       class="button btn-block button-fill add-cart-btn active together-order mypage-btn">농장
                                        개설</a>
                                </div>
                            </c:if>
                            <c:if test="${myFarm ne null}">
                                ...
                                <div>
                                    <a href="/farm/my"
                                       class="button btn-block button-fill add-cart-btn active together-order mypage-btn">
                                        농장 관리
                                    </a>
                                </div>
                            </c:if>
